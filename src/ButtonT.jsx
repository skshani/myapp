import imgA from './img/java.jpeg';
import reactImg from './img/react2.jpeg';
...
function ButtonT() {
    return (
        <div>
            ...
            <img src={imgA} alt="shani" />

            <h1>React JS BY Facebook</h1>
            <img src={reactImg} alt="hello" />

            <h1>React Open Source Library</h1>
            <img src="photo/react1.jpeg" alt="shani" />

            <h1>React Book</h1>
            <img src="photo/react2.jpeg" alt="" />

            <h1>React Book</h1>
            <img src="photo/react2.jpeg" alt="" />

            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti alias,
                saepe placeat blanditiis ab culpa esse fugiat similique cum nesciunt, praesentium in.
                Voluptatum cupiditate
                placeat consectetur. Beatae ratione consequuntur natus!</p>

            <h4>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis aliquam aspernatur
                officiis eum, corrupti quae et dicta quia, praesentium minima consectetur commodi debitis!
                Quidem quaerat iusto mollitia cupiditate adipisci. Consectetur corporis quo dolorum soluta dolore
